...
public class MuleUniqueFileTestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "muleuniquefile-functional-test-config.xml";
    }

    @Test
    public void muleuniquefile() throws Exception
    {
